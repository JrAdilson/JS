...
// Três Estilos de Funções em JS
// 1 - Declara a função e define o que faz, nesse caso imprime um Texto
                // string
// Estilos 1 - Declaração de Função, utliza-se a chave function nome(){}
function impText(texto){
    console.log(texto);
}
// 2 - Executa a função (1 ou + vezes)
impText("Alô");

// Estilos 2 - Sem passar parâmetros / famoso void em outras linguagens, necessita do return.
function soma(){
    return 2+5;
}
console.log(soma());

// Estilos 3 - Função dentro da função
impText(soma());
